...
describe("ScreenshotViewer", () => {
  it("renders nothing when screenshots array is empty", () => {
    const { container } = render(
      <ScreenshotViewer screenshots={[]} runId="run_123" />,
    );
  ...
  it("renders screenshot buttons", () => {
    const screenshots = [
      "screenshot_feature_001.png",
      "screenshot_price_002.png",
    ];
  ...
  it("renders multiple screenshots as individual buttons", () => {
    const screenshots = [
      "screenshot_a_001.png",
      "screenshot_b_002.png",
      "screenshot_c_003.png",
    ];
